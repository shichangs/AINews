...
> 注：NVDA 与 MU 的 YTD 基准本期经一手历史年度收盘数据（Stockanalysis / Digrin / Macrotrends）校正——NVDA 2025-12-31 收盘 = **$186.50**（此前序列误用约 $173.7，YTD 由含误差的 +21.6% 修正为 **+13.2%**）；MU 2025-12-31 收盘 = **$285.41**（此前序列误用约 $306.7，YTD 由 +216.6% 修正为 **+240.2%**）。AMD（$214.16）、TSLA（$449.72）基准经核对无误。
